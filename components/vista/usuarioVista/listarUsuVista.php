...
<body>
    ...
    <a href="/SiGeRuCSS+/components/vista/usuarioVista/registroUsuVista.html" class="btn-nuevo">+ Registrar nuevo usuario</a>
    ...
    <script src="/SiGeRuCSS+/ajax/usuario/gestionUsuario.js"></script>
</body>
</html>
